...
describe("AetherOffice evaluation rubric", () => {
  ...
  it("records real task count, average score, and recent performance for the evaluated employee", () => {
    evaluateImplementation("Arcee", { correctness: 80, requirements: 80, codeQuality: 80, security: 80, performance: 80, maintainability: 80, reasoning: "Verified review", recommendations: "Ship after approval" });
    const profile = getDashboardState().employees.find((employee) => employee.id === "Arcee");
