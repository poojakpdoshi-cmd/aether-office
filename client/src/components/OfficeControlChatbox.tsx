...
export function OfficeControlChatbox({ managers, messages, taskCandidate, chatPending, taskPending, meeting, approvalPending, error, onSendMessage, onStartProposedTask, onApprovePlan, onSpeak, onUpload }: Props) {
