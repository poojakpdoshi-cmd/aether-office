...
export function OfficeControlChatbox({ managers, messages, taskCandidate, chatPending, taskPending, meeting, approvalPending, manusLifecycle, workspaceSelected, error, onSendMessage, onStartProposedTask, onApprovePlan, onSpeak, onUpload, onOpenServiceFloor }: Props) {
